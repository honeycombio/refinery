...
var _ Sampler = (*EMADynamicSampler)(nil)
...
func (d *EMADynamicSampler) GetSampleRate(trace *types.Trace) (rate uint, reason string, key string) {
	...
	return rate, "emadynamic", key
}

func (d *EMADynamicSampler) MakeSamplingDecision(rate uint, trace *types.Trace) bool {
